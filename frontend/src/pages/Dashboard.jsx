...
const Dashboard = () => {
  ...
  // Mock function to trigger AI Chat (Backend would handle the AI user logic)
  const startAIChat = async () => {
    try {
      // Assuming 'ai-bot-id' is a reserved ID in your backend
  ...
  return (
    <div className="flex h-screen w-full bg-black text-white overflow-hidden font-sans">
      ...
      {/* Mini Navigation Rail (WhatsApp/Discord Style) */}
      <div className="w-16 h-full bg-[#0a0a0a] border-r border-gray-800 flex flex-col items-center py-6 gap-8">
        <div className="p-2 rounded-xl bg-linear-to-br from-purple-500 to-purple-700 shadow-[0_0_15px_rgba(168,85,247,0.4)]">
          {/* User's Requested Icon */}
