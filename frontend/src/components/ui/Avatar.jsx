...
const Avatar = ({ src, alt, size = 'w-10 h-10', fallback = '?' }) => {
  return (
    <div className={`${size} rounded-full overflow-hidden bg-linear-to-r from-purple-500 to-purple-700 flex items-center justify-center shrink-0 text-white font-semibold border border-purple-900/50`}>
      {src ? (
